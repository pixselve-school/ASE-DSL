 ...
 * </p>
 * <ul>
 *   <li>{@link miniMechaCode.impl.UnaryOperatorImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnaryOperatorImpl extends ExpressionImpl implements UnaryOperator {
	...
	protected EClass eStaticClass() {
		return MiniMechaCodePackage.Literals.UNARY_OPERATOR;
	}
	...
	public NotificationChain basicSetRight(Expression newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniMechaCodePackage.UNARY_OPERATOR__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniMechaCodePackage.UNARY_OPERATOR__RIGHT, null, msgs);
			if (newRight != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MiniMechaCodePackage.UNARY_OPERATOR__RIGHT, newRight,
					newRight));
	}
